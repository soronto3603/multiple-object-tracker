...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        for annotation in annotations_list:
            ...
            self.add_image("tomato",image_id=annotation["imagePath"],path=image_path,width=width,height=height,annotation=annotation["shapes"])
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i,poly in enumerate(polygon_list):
            ...
            rr,cc = skimage.draw.polygon(pr,pc)
            mask[rr, cc, i] = 1
